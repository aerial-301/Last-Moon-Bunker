...
const moreProperties = (o) => {
    ...
    o.removeChild = (c) => { if (c.parent === o)
        o.children.splice(o.children.indexOf(c), 1) }
}
const moreUnitsProperties = (o, n = 0) => {
    ...
    o.idleAnimation = () => {
        if (!o.idleAnimated) {
            ...
            if (o.offsetCounter >= 2)
                o.idleOffset -= 1
            else if (o.offsetCounter <= -2)
                o.idleOffset += 1
            g.wait(50, () => {
...
const makeText = (content, font, fillStyle, x, y) => {
    ...
    const o = Object.assign(Object.assign({}, g), { content: content, font: font || "12px sans-serif", fillStyle: fillStyle || "white", textBaseline: "top", render(c) {
...
const makeMovableObject = (w, h, x = 0, y = 0) => {
    ...
    const o = Object.assign(Object.assign({}, g), { speed: 3, vx: 0, vy: 0, destinationX: x, destinationY: y, scaned: false, isMoving: false, isCollided: false, isColliding: false, isCollidingH: false, isCollidingV: false, stillCheck: false, xChanged: false, yChanged: false, changedDirection: false, collidedWith: null, collisionSide: null, 
...
const mainPlayer = (x = 0, y = 0) => {
    ...
    const p = Object.assign(Object.assign({}, movableObject), { type: 'main', health: 100, baseHealth: 100, speed: 5, damage: 0, twoEyes: twoEyes, thirdEye: thirdEye, 
        // playerHand: playerHand,
        swordHandle: swordHandle, sword: sword, slash1: slash1, slash2: slash2, weaponRotation: PI, weaponAngle: C.idleSwordAngle, 
        // attacked: false,
        // attacked2: false,
        // isRolling: false,
        rollDistance: 10, rollCounter: 10, alertSent: false, attack() {
...
const newVillager = (x = 0, y = 0, armed = false) => {
    ...
    const o = Object.assign(Object.assign({}, m), { type: 'villager', health: 100, baseHealth: 100, speed: 5, damage: 0, twoEyes: twoEyes, weaponAngle: (PI / 2) + 0.1, weaponRotation: -0.2, target: null, attack(target = g.pointer) {
...
const makeEnemy = (x = 0, y = 0) => {
    ...
    const o = Object.assign(Object.assign({}, m), { baseHealth: 100, health: 100, twoEyes: eye })
